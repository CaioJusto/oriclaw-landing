...
export default function ResetPasswordPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-slate-900/60 border border-violet-500/20 rounded-2xl p-8">
        ...
        {success ? (
          ...
          <form onSubmit={handleReset} className="space-y-4">
            ...
            <input
              ...
              required
              className="w-full px-4 py-2.5 rounded-xl bg-slate-800 border border-slate-700 text-white placeholder-slate-500 focus:outline-none focus:border-violet-500"
            />
            <input
              type="password"
